    ...
    class InputManagement
    {
        ...
        public static void __HandleMoveButton(string name)
        {
            if (name == "RightButton")
                ...
                GlobalVariables.CameraPosition.Y += 160;
            if (GlobalVariables.CameraPosition.X + 480 >= GlobalVariables.ProvincesMap.Width)
                GlobalVariables.CameraPosition.X = GlobalVariables.ProvincesMap.Width - 480;
            else if (GlobalVariables.CameraPosition.X < 0)
                GlobalVariables.CameraPosition.X = 0;
            if (GlobalVariables.CameraPosition.Y + 460 >= GlobalVariables.ProvincesMap.Height)
                GlobalVariables.CameraPosition.Y = GlobalVariables.ProvincesMap.Height - 460;
