...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        void MoveCameraTo(Province p)
        {
            ...
            if (p != null)
            {
                ...
                if (p.Pixels.Any())
                {
                    ...
                    if (x + 480 >= GlobalVariables.ProvincesMap.Width)
                        x = GlobalVariables.ProvincesMap.Width - 480;
                    if (y + 460 >= GlobalVariables.ProvincesMap.Height)
                        y = GlobalVariables.ProvincesMap.Height - 460;
        ...
        void MouseClickHandler(object sender, MouseEventArgs e)
        {
            ...
            if (sender == this)
            {
                if (e.Location.X > 40 && e.Location.X < 520 && e.Location.Y > 40 && e.Location.Y < 500)
                {
        ...
        public static void UpdateMap()
        {
            ...
            switch (GlobalVariables.mapmode)
            {
                case MapManagement.UpdateMapOptions.Provinces:
                    graphics.DrawImage(GlobalVariables.ProvincesMap, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.Development:
                    graphics.DrawImage(GlobalVariables.DevelopmentBitmap, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.TradeGood:
                    graphics.DrawImage(GlobalVariables.TradeGoodBitmapLocked.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.Religion:
                    graphics.DrawImage(GlobalVariables.ReligionBitmapLocked.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.Culture:
                    graphics.DrawImage(GlobalVariables.CultureBitmapLocked.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.Political:
                    graphics.DrawImage(GlobalVariables.PoliticalBitmapLocked.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.Area:
                    graphics.DrawImage(GlobalVariables.AreaBitmapLocked.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.Region:
                    graphics.DrawImage(GlobalVariables.RegionBitmapLocked.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.TradeNode:
                    graphics.DrawImage(GlobalVariables.TradeNodeBitmap.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.HRE:
                    graphics.DrawImage(GlobalVariables.HREBitmap.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.Fort:
                    graphics.DrawImage(GlobalVariables.FortBitmap.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.Continent:
                    graphics.DrawImage(GlobalVariables.ContinentBitmap.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.Superregion:
                    graphics.DrawImage(GlobalVariables.SuperregionBitmap.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.DiscoveredBy:
                    graphics.DrawImage(GlobalVariables.DiscoveredByBitmap.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.TradeCompany:
                    graphics.DrawImage(GlobalVariables.TradeCompanyLocked.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
                case MapManagement.UpdateMapOptions.Government:
                    graphics.DrawImage(GlobalVariables.GovernmentLocked.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
                    break;
            }
            ...
            graphics.DrawImage(GlobalVariables.ClickedMask.source, new Rectangle(40, 40, 480, 460), new Rectangle(GlobalVariables.CameraPosition, new Size(480, 460)), GraphicsUnit.Pixel);
        }
        ...
        private void ModEditor_Load_1(object sender, EventArgs e)
        {
